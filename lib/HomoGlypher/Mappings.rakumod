...
our %greek-mathematical-typeface = (

    '0' => [ '𝛉', '𝜃', '𝜽', '𝝷', '𝞱', '𝚯', '𝚹', '𝛩', '𝛳', '𝜣', '𝜭', '𝝝', '𝝧', '𝞗', '𝞡', '𝚯', '𝚹', '𝛩', '𝛳', '𝜣', '𝜭', '𝝝', '𝝧', '𝞗', '𝞡' ],
    ...
    'r' => [ '𝚪', '𝛤', '𝜞', '𝝘', '𝞒' ],
    't' => [ '𝛕', '𝜏', '𝝉', '𝞃', '𝞽' ],
    'u' => [ '𝛍', '𝜇', '𝝁', '𝝻', '𝞵', '𝛖', '𝜐', '𝝊', '𝞄', '𝞾' ],
    'v' => [ '𝛎', '𝜈', '𝝂', '𝝼', '𝞶' ],
    'w' => [ '𝛚', '𝜔', '𝝎', '𝞈', '𝟂', '𝛙', '𝜓', '𝝍', '𝞇', '𝟁' ],
    'y' => [ '𝛄', '𝛾', '𝜸', '𝝲', '𝞬' ],

    'A' => [ '𝚨', '𝛢', '𝜜', '𝝖', '𝞐', '𝚲', '𝛬', '𝜦', '𝝠', '𝞚', '𝚫', '𝛥', '𝜟', '𝝙', '𝞓' ],
    'B' => [ '𝚩', '𝛣', '𝜝', '𝝗', '𝞑', '𝛃', '𝛽', '𝜷', '𝝱', '𝞫' ],
    'E' => [ '𝚬', '𝛦', '𝜠', '𝝚', '𝞔', '𝚺', '𝛴', '𝜮', '𝝨', '𝞢', '𝛆', '𝜀', '𝜺', '𝝴', '𝞮', '𝛏', '𝜉', '𝝃', '𝝽', '𝞷' ],
    'F' => [ '𝟊', '𝟋' ],
    'H' => [ '𝚮', '𝛨', '𝜢', '𝝜', '𝞖' ],
    'I' => [ '𝚰', '𝛪', '𝜤', '𝝞', '𝞘' ],
    'K' => [ '𝚱', '𝛫', '𝜥', '𝝟', '𝞙', '𝛋', '𝜅', '𝜿', '𝝹', '𝞳' ],
    'M' => [ '𝚳', '𝛭', '𝜧', '𝝡', '𝞛' ],
    'N' => [ '𝚴', '𝛮', '𝜨', '𝝢', '𝞜' ],
    'O' => [ '𝚶', '𝛰', '𝜪', '𝝤', '𝞞', '𝛉', '𝜃', '𝜽', '𝝷', '𝞱', '𝚯', '𝚹', '𝛩', '𝛳', '𝜣', '𝜭', '𝝝', '𝝧', '𝞗', '𝞡', '𝚯', '𝚹', '𝛩', '𝛳', '𝜣', '𝜭', '𝝝', '𝝧', '𝞗', '𝞡', '𝛀', '𝛺', '𝜴', '𝝮', '𝞨' ],
    'P' => [ '𝚸', '𝛲', '𝜬', '𝝦', '𝞠' ],
    'T' => [ '𝚻', '𝛵', '𝜯', '𝝩', '𝞣' ],
    'W' => [ '𝚿', '𝛹', '𝜳', '𝝭', '𝞧' ],
    'X' => [ '𝚾', '𝛸', '𝜲', '𝝬', '𝞦', '𝛘', '𝜒', '𝝌', '𝞆', '𝟀' ],
    'Y' => [ '𝚼', '𝛶', '𝜰', '𝝪', '𝞤', '𝛄', '𝛾', '𝜸', '𝝲', '𝞬' ],
    'Z' => [ '𝚭', '𝛧', '𝜡', '𝝛', '𝞕' ],
